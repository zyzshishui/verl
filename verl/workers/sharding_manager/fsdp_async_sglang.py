...
class FSDPAsyncSGLangShardingManager(BaseShardingManager):

    def __init__(self,
                 module: FSDP,
                 inference_engine: Optional[Engine],
                 model_config,
        ...
        self._tp_rank = device_mesh["infer_tp"].get_local_rank()
        self._tp_size = device_mesh["infer_tp"].mesh.size()[0]
